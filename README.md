...
* [**vdt2bmp**](https://github.com/jfdelnero/minitel/tree/master/VDT2BMP) ⭐ 72 | 🐛 3 | 🌐 C | 📅 2026-08-08 💙 -
...
* [eserandour/Minitel1B\_Hard](https://github.com/eserandour/Minitel1B_Hard) ⭐ 44 | 🐛 12 | 🌐 C++ | 📅 2026-05-23 -
  Minitel Library for Arduino (with HardwareSerial).

* [iodeo/Socketel](https://github.com/iodeo/Socketel) ⭐ 16 | 🐛 1 | 🌐 Python | 📅 2023-03-20 - A portal to Minitel
  webservices written in micropython for ESP32. Services are externally hosted,
  see [server section](#server-side).

* [jbellue/3615\_SSH](https://github.com/jbellue/3615_SSH) ⭐ 7 | 🐛 0 | 🌐 C++ | 📅 2022-12-05 - An SSH client for
  ESP32.
...
* [Picotel](https://github.com/mchobby/picotel) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2022-11-09 - A project by Dominique
...
* [cquest/websocket2minitel](https://github.com/cquest/websocket2minitel) ⭐ 5 | 🐛 1 | 🌐 Python | 📅 2022-12-24 - A
  middleware between a websocket-based Minitel server and the Minitel serial
  port. Written by Christian Quest. (EN)

* [Minitel Image Viewer](https://github.com/pR-0000/Minitel-image-viewer) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2025-08-15 - Python
...
* [**Microprocessor
  Reprogrammation**](https://github.com/jfdelnero/minitel#bon-et-apr%C3%A8s--que-peut-on-faire-avec-cela-) ⭐ 72 | 🐛 3 | 🌐 C | 📅 2026-08-08
  ...
  [the\_minitel\_demo](https://github.com/jfdelnero/minitel/tree/master/minitel2/the_minitel_demo) ⭐ 72 | 🐛 3 | 🌐 C | 📅 2026-08-08.
...
* [Zigazou/PyMinitel](https://github.com/Zigazou/PyMinitel) ⭐ 32 | 🐛 4 | 🌐 Python | 📅 2026-04-05 - A python library
  to control a Minitel from a computer running Linux using a serial interface.

* [cquest/cristel](https://github.com/cquest/cristel) ⭐ 19 | 🐛 0 | 📅 2025-10-24 - Apple II Minitel server
...
* [jiktim/minitel.js](https://github.com/jiktim/minitel.js) ⭐ 6 | 🐛 7 | 🌐 JavaScript | 📅 2024-06-18 - A
  NodeJS server to send content to a Minitel through a websocket.

* [cquest/dragster](https://github.com/cquest/dragster) ⭐ 3 | 🐛 0 | 🌐 OpenEdge ABL | 📅 2018-07-22 - Obsolete Minitel
  server (1985) using MPW (Macintosh Programmer's Workshop).

* [Zigazou/miplayer](https://github.com/Zigazou/miplayer) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2017-07-19 - A python program to
  continuously send VDT files to Minitel using serial interface(s).

* [Zigazou/HaMinitel](https://github.com/Zigazou/HaMinitel) ⭐ 0 | 🐛 0 | 🌐 Haskell | 📅 2015-02-25 - An Haskell Minitel
  server for Linux pushing content through `/dev/ttyUSB*` or a real RS-232 port
  connected to a modem.

* [Mushussu/Serveur-Minitel](https://github.com/Mushussu/Serveur-Minitel) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2015-04-11 - A
...
* [Zigazou/miedit](https://github.com/Zigazou/miedit) ⭐ 70 | 🐛 7 | 🌐 JavaScript | 📅 2024-02-15 - A browser-based Minitel
...
* [Zigazou/miedit (emulator
  section)](https://github.com/Zigazou/miedit/blob/master/EMULATOR.md) ⭐ 70 | 🐛 7 | 🌐 JavaScript | 📅 2024-02-15 - A
  Minitel emulator running in the browser.

* [bill-of-materials/docker-miedit-emulator (container)](https://github.com/bill-of-materials/docker-miedit-emulator) ⭐ 0 | 🐛 0 | 🌐 Makefile | 📅 2024-09-28 -
...
* [jfdelnero/vdt2bpm](https://github.com/jfdelnero/minitel/tree/master/VDT2BMP) ⭐ 72 | 🐛 3 | 🌐 C | 📅 2026-08-08 - A small VDT to BPM file converter.
* [jfdelnero/vdt2wav](https://github.com/jfdelnero/minitel/tree/master/Minitel_VDT2WAV) ⭐ 72 | 🐛 3 | 🌐 C | 📅 2026-08-08 - A small VDT to WAV file converter.
...
* [Zigazou/ebcdic2vdt/unitel2vdt](https://github.com/Zigazou/ebcdic2vdt) ⭐ 1 | 🐛 0 | 🌐 Shell | 📅 2018-07-16 - A C and bash program to convert EBCDIC disk images to vdt files.
* [Zigazou/teletext2minitel](https://github.com/Zigazou/teletext2minitel) ⭐ 0 | 🐛 0 | 🌐 PHP | 📅 2017-05-19 - A simple standalone CLI PHP script which tries to convert Teletext/CEEFAX pages to Minitel pages.
...
* [**hxc2001**](https://github.com/jfdelnero/minitel) ⭐ 72 | 🐛 3 | 🌐 C | 📅 2026-08-08 💙 - Hardware study of the
  ...
  rabbit hole. (FR)
* [Minitel
  Datasheets](https://github.com/mchobby/picotel/raw/master/docs/minitel2_hack/minitel-datasheets.zip) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2022-11-09 -
...
* [XReyRobert/VideotexPagesRepository](https://github.com/XReyRobert/VideotexPagesRepository) ⭐ 7 | 🐛 0 | 🌐 C | 📅 2021-07-10 -
  An archive of VDT pages with GIF conversion for modern browsing.
* [Reviving Minitel Presentation](https://github.com/Zigazou/reviving-minitel) ⭐ 1 | 🐛 0 | 📅 2020-02-04 - Sources of the “Reviving Minitel” presentation given at FOSDEM 2020 (Belgium).
